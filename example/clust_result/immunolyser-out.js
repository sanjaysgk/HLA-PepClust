            ...
            fetch('corr-data/amino_acids_comparison_with_correlation_1of6_HLA_A0101.json')
                .then(response => {
                    if (!response.ok) {
                ...
                .then(data => {
                    console.log("Loaded JSON:", 'corr-data/amino_acids_comparison_with_correlation_1of6_HLA_A0101.json', data);
                    var opt = {"renderer": "canvas", "actions": false};
                    vegaEmbed("#correlation_chart_1of6", data, opt);
                })
                .catch(error => {
                    console.error("Error fetching JSON, loading fallback image instead:", error);
                    document.getElementById("correlation_chart_1of6").innerHTML = `<img src="corr-data/amino_acids_comparison_with_correlation_1of6_HLA_A0101.png" alt="Fallback Image" width="100%">`;
                });
        
            fetch('corr-data/amino_acids_comparison_with_correlation_2of6_HLA_C1502.json')
                .then(response => {
                    if (!response.ok) {
                        throw new Error("JSON fetch failed");
                    }
                ...
                .then(data => {
                    console.log("Loaded JSON:", 'corr-data/amino_acids_comparison_with_correlation_2of6_HLA_C1502.json', data);
                    var opt = {"renderer": "canvas", "actions": false};
                    vegaEmbed("#correlation_chart_2of6", data, opt);
                })
                .catch(error => {
                    console.error("Error fetching JSON, loading fallback image instead:", error);
                    document.getElementById("correlation_chart_2of6").innerHTML = `<img src="corr-data/amino_acids_comparison_with_correlation_2of6_HLA_C1502.png" alt="Fallback Image" width="100%">`;
                });
        
            fetch('corr-data/amino_acids_comparison_with_correlation_3of6_HLA_B5101.json')
                .then(response => {
                    if (!response.ok) {
                        throw new Error("JSON fetch failed");
                    }
                ...
                .then(data => {
                    console.log("Loaded JSON:", 'corr-data/amino_acids_comparison_with_correlation_3of6_HLA_B5101.json', data);
                    var opt = {"renderer": "canvas", "actions": false};
                    vegaEmbed("#correlation_chart_3of6", data, opt);
                })
                .catch(error => {
                    console.error("Error fetching JSON, loading fallback image instead:", error);
                    document.getElementById("correlation_chart_3of6").innerHTML = `<img src="corr-data/amino_acids_comparison_with_correlation_3of6_HLA_B5101.png" alt="Fallback Image" width="100%">`;
                });
        
            fetch('corr-data/amino_acids_comparison_with_correlation_4of6_HLA_A0203.json')
                .then(response => {
                    if (!response.ok) {
                        throw new Error("JSON fetch failed");
                    }
                ...
                .then(data => {
                    console.log("Loaded JSON:", 'corr-data/amino_acids_comparison_with_correlation_4of6_HLA_A0203.json', data);
                    var opt = {"renderer": "canvas", "actions": false};
                    vegaEmbed("#correlation_chart_4of6", data, opt);
                })
                .catch(error => {
                    console.error("Error fetching JSON, loading fallback image instead:", error);
                    document.getElementById("correlation_chart_4of6").innerHTML = `<img src="corr-data/amino_acids_comparison_with_correlation_4of6_HLA_A0203.png" alt="Fallback Image" width="100%">`;
                });
        
            fetch('corr-data/amino_acids_comparison_with_correlation_5of6_HLA_C0304.json')
                .then(response => {
                    if (!response.ok) {
                        throw new Error("JSON fetch failed");
                    }
                ...
                .then(data => {
                    console.log("Loaded JSON:", 'corr-data/amino_acids_comparison_with_correlation_5of6_HLA_C0304.json', data);
                    var opt = {"renderer": "canvas", "actions": false};
                    vegaEmbed("#correlation_chart_5of6", data, opt);
                })
                .catch(error => {
                    console.error("Error fetching JSON, loading fallback image instead:", error);
                    document.getElementById("correlation_chart_5of6").innerHTML = `<img src="corr-data/amino_acids_comparison_with_correlation_5of6_HLA_C0304.png" alt="Fallback Image" width="100%">`;
                });
        
            fetch('corr-data/amino_acids_comparison_with_correlation_6of6_HLA_B5101.json')
                .then(response => {
                    if (!response.ok) {
                        throw new Error("JSON fetch failed");
                    }
                ...
                .then(data => {
                    console.log("Loaded JSON:", 'corr-data/amino_acids_comparison_with_correlation_6of6_HLA_B5101.json', data);
                    var opt = {"renderer": "canvas", "actions": false};
                    vegaEmbed("#correlation_chart_6of6", data, opt);
                })
                .catch(error => {
                    console.error("Error fetching JSON, loading fallback image instead:", error);
                    document.getElementById("correlation_chart_6of6").innerHTML = `<img src="corr-data/amino_acids_comparison_with_correlation_6of6_HLA_B5101.png" alt="Fallback Image" width="100%">`;
                });
